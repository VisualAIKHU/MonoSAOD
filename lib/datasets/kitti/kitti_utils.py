...
def object3d_to_list(obj, cls2id):
    """
    Convert an Object3d instance to a list matching the decoded prediction format:
    [class_id, alpha, xmin, ymin, xmax, ymax, h, w, l, x, y, z, ry, score]
    """
    # class_id
    class_id = cls2id.get(obj.cls_type, -1)
    # 2D bbox
    ...
    alpha = obj.alpha
    ry = obj.ry
    # score (GT is always 1.0)
    score = 1.0
    return [class_id, alpha, xmin, ymin, xmax, ymax, h, w, l, x, y, z, ry, score]
